...
ARCHITECTURE structure OF LOyAC_P1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst1|Equal0~0_combout\ = (!\inst1|cuenta\(3) & (!\inst1|cuenta\(2) & (!\inst1|cuenta\(0) & !\inst1|cuenta\(1))))
...
-- Equation(s):
-- \inst1|Equal0~3_combout\ = (!\inst1|cuenta\(13) & (!\inst1|cuenta\(12) & (!\inst1|cuenta\(15) & !\inst1|cuenta\(14))))
...
-- Equation(s):
-- \inst1|cuenta~1_combout\ = (\inst1|Add0~52_combout\ & ((!\inst1|Equal0~8_combout\) # (!\inst1|Equal0~4_combout\)))
